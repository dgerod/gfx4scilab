...
function [r] = rt_rotz(t)
// File name:       rt_rotz.sci
//
// Function:        rt_rotz
//
// Description:     homogeneous transform for rotation about Z-axis
//
// Annotations:     this code is a Scilab port of corresponding function in the
//                  Robotics Toolbox for MATLAB(R) written by Peter I. Corke.
//
// References:      Robotics Toolbox for MATLAB(R), robot7.1/rotz.m
//
