...
function [r] = rt_roty(t)
// File name:       rt_roty.sci
//
// Function:        rt_roty
//
// Description:     homogeneous transform for rotation about Y-axis
//
// Annotations:     this code is a Scilab port of corresponding function in the
//                  Robotics Toolbox for MATLAB(R) written by Peter I. Corke.
//
// References:      Robotics Toolbox for MATLAB(R), robot7.1/roty.m
//
